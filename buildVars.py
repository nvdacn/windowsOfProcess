...
addon_info = AddonInfo(
	...
	addon_name="windowsOfProcess",
	# Add-on summary/title, usually the user visible name of the add-on
	# Translators: Summary/title for this add-on
	# to be shown on installation and add-on information found in add-on store
	addon_summary=_("WindowsOfProcess"),
	# Add-on description
	...
	addon_changelog=_("""### 2025.6.14

Bump version, compatible with NVDA 2025.1.0."""),
	# Author(s)
	addon_author="沉浮 <394434124@qq.com>",
	# URL for the add-on documentation support
	addon_url="https://www.nvdacn.com/",
	# URL for the add-on repository where the source code can be found
	addon_sourceURL="https://github.com/nvdacn/windowsOfProcess",
